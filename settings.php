		  ...
		  <table border="0" cellspacing="6" cellpadding="6">
			...
			<tr>
			  ...
			  <select name="js_pause" id="js_pause">
				<option value="true" <?php if(get_option('js_pause')) echo "selected" ?>><?php _e('Yes', 'jquery_slider') ?></option>
				<option value="false" <?php if(!get_option('js_pause')) echo "selected" ?>><?php _e('No', 'jquery_slider') ?></option>
			  </select></td>
			</tr>
			<tr>
